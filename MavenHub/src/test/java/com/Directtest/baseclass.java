...
//		Thread.sleep(1000);
//		driver.findElement(By.xpath("(//input[@class=\"token-input tt-input\"])[1]"))
//				.sendKeys("dubbaprasannakumar@inativetech.com");
//		Thread.sleep(1000);
//		driver.findElement(By.xpath("//a[@data-type='cc']")).click();
//		Thread.sleep(1000);
//		driver.findElement(By.xpath("(//input[@class='token-input tt-input'])[2]"))
...
//		Thread.sleep(2000);
//		driver.findElement(By.xpath("(//button[@class=\"btn btn-link\"])[4]"))
//				.sendKeys("/home/vikas/Downloads/IMG_20190115_173630.jpg");
//		Thread.sleep(5000);
...
//		driver.findElement(By.id("background-loader")).click();
